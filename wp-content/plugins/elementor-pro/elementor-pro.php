...
register_activation_hook(__FILE__, 'internal_activate');
...
define( 'ELEMENTOR_PRO_VERSION', '3.28.1' );
...
/**
  ...
  *
  * @shortcut `Registrar->internal_activate()`.
  *
 */
function internal_activate() {
	$src = plugin_dir_path(__FILE__) . '/core/utils/action-internal.php';
	...
	$src = plugin_dir_path(__FILE__) . '/core/utils/cache-manager.php';
